...
import jakarta.persistence.*; // Importa las anotaciones de JPA necesarias.
import java.io.Serializable; // Importa la interfaz Serializable para permitir la persistencia de objetos.
...
@Table(name="futbol")
public class Futbol implements Serializable { // Implementa Serializable para permitir la serialización.
    ...
    private Long id; // Identificador único para cada registro de la tabla.

    // Define la columna 'nombre' con una longitud máxima de 100 caracteres.
    @Column(length = 100)
    private String nombre; // Nombre del deporte.

    private Long jugadoresPorEquipos; // Cantidad de jugadores por equipo.
    ...
    // Métodos getter y setter para acceder y modificar el campo id.
    public Long getId() {
    ...
    // Métodos getter y setter para acceder y modificar el campo nombre.
